		...
		<form action="/admin/adminMovieUpdate.yh" method="post" enctype="multipart/form-data">
			...
			<div id="modify-type-wrap">
				...
				<div class="input">
					...
					<input type="checkbox" class="type-input" name="movieGenre" value="로맨스" <c:if test="${movie.movieGenre == '로맨스' }">checked</c:if>>로맨스
					...
					<input type="checkbox" class="type-input" name="movieGenre" value="스릴러" <c:if test="${movie.movieGenre == '스릴러' }">checked</c:if>>스릴러
					<input type="checkbox" class="type-input" name="movieGenre" value="애니메이션" <c:if test="${movie.movieGenre == '애니메이션' }">checked</c:if>>애니메이션<br>
				</div>
			</div>
			<div id="runtime-wrap">
				<span class="movie-modify-title">상영 시간 (분)</span>
			...
			<div id="director-wrap">
				<span class="movie-modify-title">감독</span>
			...
			<div id="actor-wrap">
				<span class="movie-modify-title">배우</span>
			...
			<div class="modify-date-wrap">
				<span class="title">개봉 예정일</span>
				<input type="date" class="modify-date-input" name="movieStartday" value="${movie.movieStartday }"><br>
			</div>
			<div class="modify-date-wrap">
				<span class="title">예매 시작일</span>
				<input type="date" class="modify-date-input" name="movieTicketingday" value="${movie.movieTicketingday }"><br>
			</div>
			<div class="modify-date-wrap">
				<span class="title">상영 종료일</span>
				<input type="date" class="modify-date-input" name="movieEndday" value="${movie.movieEndday }"><br>
			</div>
			<div id="story-wrap">
