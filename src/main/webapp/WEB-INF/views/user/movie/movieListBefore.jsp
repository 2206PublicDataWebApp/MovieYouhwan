...
<body>
    ...
    <div class="midmovie-wrapper">
    	...
    	<div class="movielist-tab">
			...
			<div class="movielist-tab-on" onclick="location.href='/movieListBefore.yh?currentPage=${pageInfo.currentPage}'">상영 종료 영화</div>
    	</div>
    	<!-- 영화 리스트 -->
						...
						<div id="ticketBtn-zzim">
							...
							<form action="/saveZzim" method="post">
								...
								<c:if test="${not empty loginUser.memberId}">
										<c:if test="${movieList.zzimYn eq 'N'}">
										...
										<c:if test="${movieList.zzimYn eq 'Y'}">
