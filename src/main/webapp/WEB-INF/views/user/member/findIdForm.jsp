...
<link rel="stylesheet" href="/resources/css/user/member/findPassword.css" />
...
<jsp:include page="/WEB-INF/views/common/header.jsp"></jsp:include>
 <div id="findIdForm">
        <div id="container">
        <form action="/member/findId.yh" method="get">
            ...
            <div class="findId-input">
                ...
                <div class="input-wrap">
                    <input type="text" class="input-box" name="memberBirth" placeholder="생년월일 ex)20221004 ">
                </div>
                <div class="input-wrap">
